			...
			<View style={styles.container}>
				...
				>
					<ScrollView style={styles.contentContainer}>
						...
						<Text style={styles.description}>MyLostPet es un sitio web para el intercambio de información sobre mascotas que han sido encontradas y necesitan volver con sus dueños . Al utilizar el sitio de MyLostPet, aceptas y acuerdas estar obligado por los siguientes términos y condiciones. Nada en estas Condiciones debe ser interpretado como una concesión de derechos de terceros beneficiarios.</Text>
						...
						<Text style={styles.description}>Al enviar, publicar o mostrar cualquier material en y a través del sitio, automáticamente el usuario nos otorga y autoriza una licencia mundial (permiso) para utilizar de manera gratuita, libre de regalías, con derecho de exhibir públicamente o distribuir estos materiales en cualquier formato que el equipo de MyLostPet considere pertinente y a perpetuidad.</Text>
						...
						<Text style={styles.description}>BAJO NINGUNA CIRCUNSTANCIA MYLOSTPET SERA RESPONSABLE POR DAÑOS INDIRECTOS, INCIDENTAL, CONSECUENTE, ESPECIAL O EJEMPLAR QUE SURJA DE O EN CONEXION CON EL USO DEL SITIO WEB.</Text>
					</ScrollView>
				</Image>
			</View>
		)
